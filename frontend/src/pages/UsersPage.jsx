...
// import { Pencil, Trash2, User, UserCheck, Users, ChevronLeft, ChevronRight } from "lucide-react";
// import { useAttendanceStore } from "../store/attendanceStore";

// const UsersPage = () => {
//     const { isDarkMode, getAllUsers } = useAuthStore();
...
//     useEffect(() => {
//         const fetchInternsWithRemainingHours = async () => {
//             try {
...
//         fetchInternsWithRemainingHours();
//     }, []);
...
//                         Manage Interns
//                     </h2>
//                     <button className={`px-4 py-2 rounded-lg text-white ${isDarkMode ? "bg-green-600" : "bg-blue-600"} hover:opacity-90 transition-opacity`}>
//                         Add New Intern
//                     </button>
//                 </div>
...
//                {/* Edit User Modal - Simplified for Role and Team only */}
...
//                                 <img 
//                                     src={currentUser.image ? `http://localhost:3000/images/${currentUser.image}` : "/profile.png"} 
...
import { useAuthStore } from "../store/authStore";
import { useState, useEffect } from "react";
import { Pencil, Trash2, User, UserCheck, Users, ChevronLeft, ChevronRight, X } from "lucide-react";
import { useAttendanceStore } from "../store/attendanceStore";
import { toast } from "react-hot-toast";

const UsersPage = () => {
    const { isDarkMode, getAllUsers, addNewIntern, deleteIntern } = useAuthStore();
    const { getInternRemainingHours } = useAttendanceStore();
    const [showEditModal, setShowEditModal] = useState(false);
    const [showDeleteModal, setShowDeleteModal] = useState(false);
    ...
    const confirmEdit = async () => {
        setIsLoading(true);
        try {
            // Implementation for updating user roles and team would go here
